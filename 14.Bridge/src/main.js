...
cm1.wolrd.defaultContactMaterial = defaultContactMaterial;
cm1.wolrd.addContactMaterial(glassDefaultContactMaterial);
cm1.wolrd.addContactMaterial(playerGlassContactMaterial);
...
function draw() {
  ...
  cm1.wolrd.step(cannonStepTime, delta, 3);
